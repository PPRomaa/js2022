...
//
// console.log(arrayNum.map(value => value.toString()));
...
// let decay = coursesAndDurationArray.sort((a1, a2) => {
...
// let aceofspades = cards.find(value => value.cardSuit === 'spades' && value.value === 'Ace')
...
// - всі буби
// let alldiamondcards = cards.filter(value => value.cardSuit === 'diamonds')
// console.log(alldiamondcards);

// - всі трефи від 9 та більше
// let biggernine = cards.filter(value => value.value > 8 + '' && value.cardSuit === 'spades')
// console.log(biggernine);
...
// let filter = cards.reduce(function (accumulator,user){
//     if (user.cardSuit === 'spades'){
//         accumulator.spades.push(user)
//     }else if (user.cardSuit === 'diamonds'){
//         accumulator.diamonds.push(user)
//     }else if (user.cardSuit === 'hearts'){
