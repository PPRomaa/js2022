...
//         for (const blockEl in blockDiv) {
//             if (typeof blockDiv[blockEl] !== 'object'){
//                 let block = document.createElement(`div`)
//                 block.append(blockDiv[blockEl])
//                 document.body.appendChild(block)
//             }
//             else{
//                 block(blockDiv[blockEl])
//             }
//         }
//     }
//     block(usersListElement)
// }
...
function foo (htmlElement){
    if (htmlElement.tagName === 'p'){
        paragraphs.push(htmlElement)
    }else if (htmlElement.tagName){
        headings.push(htmlElement)
    }
...
// ------
//
//     зробити div contenteditable ввести будь яке ціле слово. та при натисканні табуляції перетворити
//     його на подвійний тег
// asd ->tab-> <asd></asd>